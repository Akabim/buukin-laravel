                ...
                <div class="w-full self-center justify-center lg:px-12">
                    <div class="flex-wrap inline-flex sticky mb-7">
                        <div
                            ...
                            <input
                                class="border-transparent focus:border-transparent focus:ring-0 py-2.5 lg:w-[975px] w-full pr-4 pl-4 bg-white rounded-full focus:outline-none"
                        ...
                        <div class="w-44 bg-primary rounded-full lg:ml-12 hidden lg:flex">
                            <select name="" id=""
                                class="border-transparent focus:border-transparent focus:ring-0 mt-3 lg:mt-0 w-full lg:w-40 lg:pr-2 p-2.5 bg-primary text-white  rounded-full">
