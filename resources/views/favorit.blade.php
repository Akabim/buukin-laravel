            ...
            <div class="w-full self-center justify-center lg:px-12">
                <div class="flex-wrap inline-flex sticky mb-7">
                    <div class="search-form bg-white rounded-full flex justify-center items-center border border-primary ">
                        <input class="border-transparent focus:border-transparent focus:ring-0 py-2.5 lg:w-[975px] w-full pr-4 pl-4 bg-white rounded-full focus:outline-none" type="text" name="search" id="searchbar" onkeyup="search_resto()" placeholder="Cari disini..." />
                        <label>
                            <i class="mr-4 lg:w-6 lg:h-6 text-primary w-5 h-5" data-feather="search"></i>
                        </label>
                    </div>
                    <div class="w-44 bg-primary rounded-full lg:ml-12 hidden lg:flex">
                        <select name="" id="" class="border-transparent focus:border-transparent focus:ring-0 mt-3 lg:mt-0 w-full lg:w-40 lg:pr-2 p-2.5 bg-primary text-white  rounded-full">
            ...
            <div class="w-full self-start px-4 lg:pr-12 lg:w-2/3 lg:pb-10 ">
                <div class="flex flex-wrap mb-5">
                    <div class="w-full lg:w-1/2 justify-start">
                        <h1 class="lg:text-2xl text-lg font-semibold text-black">Tempat Favoritmu</h1>
                    </div>
