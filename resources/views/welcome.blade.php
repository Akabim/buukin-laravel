    ...
    <header class="bg-transparent absolute top-0 left-0 w-full flex items-center z-10 shadow-md">
        <div class="container mx-auto">
            <div class="flex items-center justify-between relative py-3 px-4">
                <div class="px-4 flex">
                    <a href="./index.html" class="font-bold text-lg text-primary block py-2"> <img
                ...
                <div class="w-full self-center justify-center px-4 lg:px-12">
                    <div class="flex-wrap inline-flex sticky">
                        <form action="" method="GET">
                            <div
                                ...
                                <input type="text" name="search"
                                    ...
                                    type="search" name="search" id="searchbar" onkeyup="liveSearch()"
                                    placeholder="Cari disini..." /> <label>
                        ...
                        <div class="w-40 bg-primary rounded-full lg:ml-12 hidden lg:flex">
                            <select name="" id=""
                                class="mt-3 lg:mt-0 w-full lg:w-40 lg:pr-2 p-2.5 bg-primary text-white  rounded-full border-transparent focus:border-transparent focus:ring-0">
                    ...
                    <div class="swiper lg:rounded-xl rounded-lg mt-7 lg:w-full flex-shrink sample-slider">
                        ...
                        <div class="swiper-wrapper  w-full">
                            <!-- Slides -->
                            <div class="swiper-slide w-full "><img src="{{ asset('img/banner.png') }}"
                                    class="w-[1513px] rounded-lg" alt=""></div>
                            <div class="swiper-slide w-full "><img src="{{ asset('img/banner.png') }}"
                                    class="w-[1513px] rounded-lg" alt=""></div>
                            <div class="swiper-slide w-full "><img src="{{ asset('img/banner.png') }}"
                                    class="w-[1513px] rounded-lg" alt=""></div>
            ...
            <div class="flex flex-wrap">
                    ...
                    <div class="swiper2 lg:rounded-xl mt-3 lg:w-full flex-shrink sample-slider">
                        ...
                        <div class="swiper-wrapper flex-shrink  max-w-full">
                            @foreach ($restos as $resto)
                                <div class="swiper-slide restoran w-full "><a
                                        href="{{ route('details.show', $resto->id) }}"
                                        ...
                                        <div class="mt-3 flex justify-between ">
                                            ...
                                            <p class="text-gray-900 font-semibold inline-flex ">
                                                {{ $resto->ratings }}<svg class=" ml-1.5 w-5 h-5 text-yellow-200"
                ...
                <div class="mt-7 w-full self-center justify-center px-4 lg:px-12 div-to-hide">
                    ...
                    <div class="swiper2 lg:rounded-xl mt-3 lg:w-full flex-shrink sample-slider">
                        ...
                        <div class="swiper-wrapper flex-shrink  max-w-full">
                            @foreach ($restos as $resto)
                                <div class="swiper-slide restoran w-full "><a href="./detail-resto.html"
                                        class="group block rounded-lg">
                                        <img src="{{ asset('storage/' . $resto->photo_1) }}" alt=""
                                            class="h-full w-full object-cover sm:h-full rounded-lg" />
