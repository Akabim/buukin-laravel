...
<body class="scroll-smooth">
    <header class="bg-transparent absolute top-0 left-0 w-full flex items-center z-10 shadow-md">
        <div class="container mx-auto">
            <div class="flex items-center justify-between relative py-3 px-4">
                <div class="px-4 flex">
                    <a href="./index.html" class="font-bold text-lg text-primary block py-2"> <img src="{{ asset('img/logo.png') }}" width="126px" height="29px" class="mt-1 lg:scale-110" alt="" />
                    </a>
                </div>
                    ...
                    <nav id="nav-menu" class="hidden absolute py-5 bg-white shadow-lg rounded-lg max-w-[250px] w-full lg:right-1/2 lg:top-1/2 right-4 top-full lg:block lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none">
                        <ul class="block lg:flex justify-center">
                            <li class="group lg:text-center">
                                <a href="{{ url('/dashboard') }}" class="text-primary lg:text-primary py-2 px-8 group-hover:underline underline-offset-8 group-hover:text-primary group-hover:font-semibold flex transition ease-in-out">Beranda</a>
                            </li>
                            <li class="group lg:text-center">
                    ...
                    <div class="flex-wrap inline-flex sticky">
                        <form action="" method="GET">
                            <div class="search-form bg-white rounded-full flex justify-center items-center border border-primary ">
                                <input type="text" name="search" class="border-transparent focus:border-transparent focus:ring-0 py-2.5 lg:w-[975px] pr-4 pl-4 bg-white rounded-full focus:outline-none border-none" type="search" name="search" id="searchbar" onkeyup="liveSearch()" placeholder="Cari disini..." /> <label>
    ...
    <section class="pt-8 pb-20 bg-white">
        <div class="container mx-auto">
            <div class="flex flex-wrap">
                <div class="w-full self-center justify-center px-4 lg:px-12 div-to-hide">
                    <div class="flex flex-wrap">
                        ...
                        <div class="swiper-wrapper flex-shrink  max-w-full">
                            ...
                            <div class="swiper-slide restoran w-full "><a href="{{ route('details.show', $resto->id) }}" class="group block rounded-lg">
                                    ...
                                    <div class="mt-3 flex justify-between ">
                                        ...
                                        <p class="text-gray-900 font-semibold inline-flex ">
                                            {{ $resto->ratings }}<svg class=" ml-1.5 w-5 h-5 text-yellow-200" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                ...
                <div class="mt-7 w-full self-center justify-center px-4 lg:px-12 div-to-hide">
                    <div class="flex flex-wrap">
                        <div class="w-full lg:w-1/2 justify-start">
    ...
    <footer class="bg-gray-100">
        <div class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
            ...
            <p class="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
                Buukin' merupakan platform yang dapat membantu anda menemukan restoran sesuai yang anda inginkan,
                rasakan kemudahan reservasi dengan fitur-fitur yang kami berikan.
            </p>
