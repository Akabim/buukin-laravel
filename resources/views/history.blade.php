...
@section('content')
<section class="pt-36 pb-20 px-4 lg:px-14 bg-white">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div class=" hover:bg-primary bg-[#EDEDED] transition py-3 px-3 rounded-xl">
            <a href="./detail-resto.html" class="group block rounded-lg">
                <img src="{{ asset('storage/' . $booking->restaurant->photo_1) }}" alt="" class="h-full w-full object-cover rounded-lg" />
                <div class="mt-3">
                    ...
                    <button type="submit" id="sweetalert" class="group-hover:border-white group-hover:border-2 cursor-pointer mt-3 w-full py-3 px-2 rounded-lg bg-primary text-white lg:text-lg">
                        Details
                    </button>
                </div>
            </a>
