        ...
        <div class="container mx-auto">
            <div class="flex flex-wrap">
                <div class="w-full self-start px-4 lg:px-12 lg:w-1/2 lg:pb-10">
                    <div class="relative lg:right-0 "><img id="mainImage" src="{{ asset('storage/' . $restos->photo_1) }}" alt="abimanyu" class=" w-full mx-auto relative " /></div>
                ...
                <div class=" w-full px-4 sticky top-0 lg:w-1/2"">
                    ...
                    <div class="w-full block">
                        ...
                        <div class="w-full inline-flex my-2">
                            ...
                            <a href="{{ route('dashboard') }}" class="w-full bg-primary px-y py-7 rounded-2xl text-lg text-white">Kembali ke
                                Beranda</a>
                            @else
                            <button type="submit" id="pay-button" class="w-full bg-primary px-y py-7 rounded-2xl text-lg text-white">Bayar
                                Sekarang</button>
                            @endif
                        </div>
                    </div>
